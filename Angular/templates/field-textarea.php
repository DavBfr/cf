...
<div class="form-group" data-ng-class="{'has-error': form.<?php echo $field->getName() ?>.$invalid}">
	...
	<div class="col-sm-10">
		<textarea class="form-control" rows="20" id="<?php echo $field->getName() ?>" data-ng-required="<?php echo !$field->hasNull() ?>" name="<?php echo $field->getName() ?>" data-ng-model="item.<?php echo $field->getName() ?>" placeholder="<?php echo $field->getCaption() ?>"></textarea>
