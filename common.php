...
configure("CF_TEMPLATES_DIR", CF_DIR . DIRECTORY_SEPARATOR . "templates");
configure("CF_TEMPLATES_PATH", CF_WWW_PATH . DIRECTORY_SEPARATOR . "partials");
configure("CF_MEDIA_DIR", CF_WWW_DIR . URL_SEPARATOR . "media");
configure("CF_MEDIA_PATH", CF_WWW_PATH . URL_SEPARATOR . "media");
